    ...
    sealed class BezierShapeEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            for (int index = 0; index < count; index++)
            {
                ...
                {
                    prev = point.position;
                    var fmh_550_57_638297042325027026 = Quaternion.identity; prev = Handles.FreeMoveHandle(prev, size, Vector3.zero, Handles.DotHandleCap);
                ...
                if (m_CloseLoop || index > 0)
                {
                    ...
                    else
                    {
                        ...
                        var fmh_583_61_638297042325044807 = Quaternion.identity; prev = Handles.FreeMoveHandle(prev, size, Vector3.zero, Handles.DotHandleCap);
                ...
                if (m_CloseLoop || index < count - 1)
                {
                    ...
                    else
                    {
                        ...
                        var fmh_615_61_638297042325047614 = Quaternion.identity; prev = Handles.FreeMoveHandle(prev, size, Vector3.zero, Handles.DotHandleCap);
